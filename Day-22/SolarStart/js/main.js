...
function calculateSolar() {
    ...
    var miniKwNeeds = dailyUseKw / sunHoursPerDay;
    console.log(miniKwNeeds);

    var realKwNeeds = miniKwNeeds * 1.25;
    ...
    var feedback = '';
    feedback += `<p>Based on your average daily use of ${dailyUseKw} KWh, you will need to purchase ${panelsNeeded} solar panels to offset 100% your electricity bills</p>`;
    feedback += `<h2>Additional Details</h2>`;
    feedback += `<p>Your average daily electricity consumption: ${miniKwNeeds} Kwh per day.</p>`;
